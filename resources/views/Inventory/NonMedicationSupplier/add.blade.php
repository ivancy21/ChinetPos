...
@section('contents')
      ...
      <form class="form-horizontal" method="POST" action="{{route('nonMedicationSuppliers.store')}}">
            @csrf
  ...
  <div class="col-sm-8">
                            ...
                            <div class="flex HeaderBody">
                                ...
                                <div class="row mb-2">
                                        ...
                                        <div class="col-sm-5">              
                                                <input type="hidden" id="nonMedicationId" class="form-control" value="{{$nonMedication->id}}" name="nonMedicationId">
    ...
    .                                               @endforeach
                      ...
                      <div class="DivTemplate">
                          ...
                          <button class="btn btn-outline-info waves-effect float-right btn-sm" type="button" onclick="window.location = '{{ route('nonMedicationSuppliers.show',$nonMedication->id) }}'">BACK</button>    
                      </div>
